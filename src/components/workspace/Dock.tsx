...
const dockGroups: DockGroup[] = NAV_GROUPS.map((g) => ({
  groupKey: g.groupKey,
  labelKey: g.groupKey,
  icon: g.icon,
  accent: g.accent,
...
interface DockProps {
  roleKey: string;
  /** Dérogations utilisateur : le dock affiche exactement ce que le serveur autorise. */
  permissionOverrides?: PermissionOverrides;
}

export function Dock({ roleKey, permissionOverrides }: DockProps) {
  const {
    windows,
    activeWindowId,
    openWindow,
