...
// La table SITE_PATHS et les types associés sont extraits dans un sous-module
// dédié pour réduire la taille de ce fichier. Voir `./site-scope/site-paths`.
export { type SitePath, SITE_PATHS, SHARED_NULL_MODELS } from "./site-scope/site-paths";
import { SITE_PATHS, SHARED_NULL_MODELS } from "./site-scope/site-paths";
