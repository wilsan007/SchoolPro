...
-- TENANT: Lycee de demonstration
INSERT INTO "tenants" (id, slug, name, "logoUrl", "planType", "isActive", "createdAt", "updatedAt")
VALUES ('cmsr213n70000zbfuirwopmuo', 'demo-learnos', 'Lycee de demonstration', NULL, 'PREMIUM', true, '2026-08-13 08:48:18', '2026-08-13 08:48:18')
...
-- ============================================================
-- QA USERS - 5 accounts for testing all roles
-- Password: Demo@2026! (bcrypt hash)
-- ============================================================
...
-- Class Teacher / Prof Principal (CLASS_TEACHER)
INSERT INTO "users" (id, "tenantId", "siteId", email, password, name, "firstName", "lastName", "avatarUrl", phone, role, "isActive", "lastLoginAt", langue, locale, notifications, "createdAt", "updatedAt")
VALUES (
...
-- prof@qa-learnos.test      | Demo@2026!    | Teacher
-- pp@qa-learnos.test        | Demo@2026!    | Class Teacher
-- parent@qa-learnos.test    | Demo@2026!    | Parent
-- eleve@qa-learnos.test     | Demo@2026!    | Student
-- ============================================================
