...
export default defineConfig({
  ...
  test: {
    ...
    include: ["src/**/*.{test,spec}.{ts,tsx}", "tests/unit/**/*.{test,spec}.{ts,tsx}", "tests/integration/**/*.{test,spec}.{ts,tsx}", "tests/rls/matrice-routes.test.ts", "tests/rls/rls-modes.test.ts"],
    coverage: {
      provider: "v8",
